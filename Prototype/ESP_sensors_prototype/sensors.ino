...
void loop() 
{
  ...
  if (client) {
    ...
    while(client.connected()){      
      ...
      if (firstDetectionTime - secondDetectionTime >50 && firstDetectionTime - secondDetectionTime < 2000) {
        detectionState = 1;
        // Detection state = 1 for someone enter the room.
      } else if (secondDetectionTime - firstDetectionTime >50 && secondDetectionTime - firstDetectionTime < 2000) {
        detectionState = 2;
